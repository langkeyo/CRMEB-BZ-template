...
<style lang="scss">
    ...
    .header-navbar {
        ...
        .action-btns {
            ...
            .favorites-btn {
                ...
                .star-icon {
                    font-size: 54rpx; /* 18px * 2 - 调整为与其他图标相似大小 */
                    color: #FFFFFF;
                    line-height: 1;
                    text-align: center;
                    margin-bottom: 6rpx;
    ...
    .business-brand-profile-section {
        width: 750rpx; /* 375px * 2 */
        height: 356rpx; /* 178px * 2 */
        background: #FFFFFF;
        border-radius: 8rpx 8rpx 0px 0px; /* 4px * 2 */
        position: relative;
        padding: 20rpx 24rpx; /* 统一的内边距：上下10px，左右12px */
        box-sizing: border-box;
        flex-shrink: 0;
    }
    ...
    .top-section {
        width: 100%; /* 使用100%宽度 */
        height: 168rpx; /* 84px * 2 */
        position: relative;
        display: flex;
        align-items: flex-start;
        margin-bottom: 20rpx; /* 与bottom-section的间距 */
    }

    /* logo */
    .logo {
        width: 154rpx; /* 77px * 2 */
        height: 154rpx; /* 77px * 2 */
    ...
    /* left */
    .left {
        flex: 0 0 200rpx; /* 增加宽度 100px * 2 */
        display: flex;
        flex-direction: column;
        gap: 20rpx; /* 10px * 2 */
        padding: 10rpx; /* 恢复适当的内边距 */
    }
    ...
    .condition-card {
        background: #F7F7F7;
        border-radius: 8rpx; /* 4px * 2 */
        padding: 12rpx 16rpx; /* 6px 8px * 2 */
        min-height: 86rpx; /* 最小高度 43px * 2 */
        display: flex;
        flex-direction: column;
        justify-content: center;
        align-items: center;
    ...
    .right {
        ...
        justify-content: center;
        align-items: flex-start;
        height: 298rpx; /* 与左侧高度完全一致 */
    }

    /* chart-pane */
    .chart-pane {
        width: 426rpx; /* 213px * 2 */
        height: 298rpx; /* 与左侧高度完全一致 */
        position: relative;
        display: flex;
        align-items: center;
    ...
    .doughnut-canvas {
        width: 426rpx; /* 213px * 2 */
        height: 298rpx; /* 149px * 2 - 与左侧高度完全一致 */
